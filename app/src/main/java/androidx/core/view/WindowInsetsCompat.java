...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return getSystemWindowInsets().f3top;
    }
    ...
    public WindowInsetsCompat inset(Insets insets) {
        return inset(insets.left, insets.f3top, insets.right, insets.bottom);
    }
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f3top - i2);
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        void setSystemWindowInsets(Insets insets) {
            ...
            if (windowInsets != null) {
                this.mInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f3top, insets.right, insets.bottom);
            }
        }

...
public class FontsContractCompat {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        Uri withAppendedId;
        ArrayList arrayList = new ArrayList();
        Uri build = new Uri.Builder().scheme(Utils.RESPONSE_CONTENT).authority(str).build();
        Uri build2 = new Uri.Builder().scheme(Utils.RESPONSE_CONTENT).authority(str).appendPath("file").build();
        Cursor cursor = null;
        try {

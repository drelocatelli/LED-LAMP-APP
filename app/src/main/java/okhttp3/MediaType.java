    ...
    public static MediaType get(String str) {
        ...
        for (int end = matcher.end(); end < str.length(); end = matcher2.end()) {
            ...
            if (!matcher2.lookingAt()) {
                throw new IllegalArgumentException("Parameter is not formatted correctly: \"" + str.substring(end) + "\" for: \"" + str + TokenParser.DQUOTE);
            }
            ...
            if (group != null && group.equalsIgnoreCase("charset")) {
                ...
                if (str2 != null && !group2.equalsIgnoreCase(str2)) {
                    throw new IllegalArgumentException("Multiple charsets defined: \"" + str2 + "\" and: \"" + group2 + "\" for: \"" + str + TokenParser.DQUOTE);
                }
                str2 = group2;
            }
        }

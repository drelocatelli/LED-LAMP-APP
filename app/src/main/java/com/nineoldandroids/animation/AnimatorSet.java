...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet mo57clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo57clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node m58clone = next.m58clone();
            hashMap.put(next, m58clone);
            animatorSet.mNodes.add(m58clone);
            animatorSet.mNodeMap.put(m58clone.animation, m58clone);
            ArrayList arrayList = null;
            m58clone.dependencies = null;
            m58clone.tmpDependencies = null;
            m58clone.nodeDependents = null;
            m58clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m58clone.animation.getListeners();
            if (listeners != null) {
    ...
    public static class Node implements Cloneable {
        ...
        /* renamed from: clone */
        public Node m58clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo57clone();
                return node;

...
public class PropertyValuesHolder implements Cloneable {
    ...
    @Override // 
    /* renamed from: clone */
    public PropertyValuesHolder mo61clone() {
        try {
            PropertyValuesHolder propertyValuesHolder = (PropertyValuesHolder) super.clone();
            propertyValuesHolder.mPropertyName = this.mPropertyName;
            propertyValuesHolder.mProperty = this.mProperty;
            propertyValuesHolder.mKeyframeSet = this.mKeyframeSet.mo59clone();
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override // com.nineoldandroids.animation.PropertyValuesHolder
        /* renamed from: clone */
        public IntPropertyValuesHolder mo61clone() {
            IntPropertyValuesHolder intPropertyValuesHolder = (IntPropertyValuesHolder) super.mo61clone();
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override // com.nineoldandroids.animation.PropertyValuesHolder
        /* renamed from: clone */
        public FloatPropertyValuesHolder mo61clone() {
            FloatPropertyValuesHolder floatPropertyValuesHolder = (FloatPropertyValuesHolder) super.mo61clone();

...
public class RGBWCPDataBase {
    public static RGBWCPDataBase mrgbwcp;
    private static MySqliteModeHelper mySqliteModeHelper;
    private SQLiteDatabase db;

    private RGBWCPDataBase(Context context) {
    ...
    public static RGBWCPDataBase getInstance(Context context) {
        if (mrgbwcp == null) {
            mrgbwcp = new RGBWCPDataBase(context);
        }
        return mrgbwcp;
    }
    ...
    public void update(String str, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, String str2, String[] strArr) {
        ...
        if (str.equals(MySqliteModeHelper.RGBWCP)) {
        ...
        this.db.update(MySqliteModeHelper.RGBWCP, contentValues, str2, strArr);
    }
    ...
    public void insert(String str, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        this.db.insert(MySqliteModeHelper.RGBWCP, null, contentValues);
    }

...
public class BWDataBaseOne {
    public static BWDataBaseOne bwDataBaseOne;
    private static MySqliteModeHelper mySqliteModeHelper;
    private SQLiteDatabase db;

    private BWDataBaseOne(Context context) {
    ...
    public static BWDataBaseOne getInstance(Context context) {
        if (bwDataBaseOne == null) {
            bwDataBaseOne = new BWDataBaseOne(context);
        }
        return bwDataBaseOne;
    }
    ...
    public void update(String str, int i, int i2, int i3, int i4, int i5, int i6, String str2, String[] strArr) {
        ...
        if (str.equals(MySqliteModeHelper.BWONE)) {
        ...
        this.db.update(MySqliteModeHelper.BWONE, contentValues, str2, strArr);
    }
    ...
    public void insert(String str, int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        this.db.insert(MySqliteModeHelper.BWONE, null, contentValues);
    }
    ...
    public void create(String str) {
        this.db.execSQL("create table if not exists bwone(_id integer primary key autoincrement,HOUR integer,MINUTE integer,RED integer,GREEN integer,BLUDE integer,WHITE integer)");
    }

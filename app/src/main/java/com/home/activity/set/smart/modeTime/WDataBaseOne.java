...
public class WDataBaseOne {
    private static MySqliteModeHelper mySqliteModeHelper;
    public static WDataBaseOne wDataBaseOne;
    private SQLiteDatabase db;

    private WDataBaseOne(Context context) {
    ...
    public static WDataBaseOne getInstance(Context context) {
        if (wDataBaseOne == null) {
            wDataBaseOne = new WDataBaseOne(context);
        }
        return wDataBaseOne;
    }
    ...
    public void update(String str, int i, int i2, int i3, int i4, int i5, int i6, String str2, String[] strArr) {
        ...
        if (str.equals(MySqliteModeHelper.WONE)) {
        ...
        this.db.update(MySqliteModeHelper.WONE, contentValues, str2, strArr);
    }
    ...
    public void insert(String str, int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        this.db.insert(MySqliteModeHelper.WONE, null, contentValues);
    }
    ...
    public void create(String str) {
        this.db.execSQL("create table if not exists wone(_id integer primary key autoincrement,HOUR integer,MINUTE integer,RED integer,GREEN integer,BLUDE integer,WHITE integer)");
    }

...
public class RGBDataBaseOne {
    public static RGBDataBaseOne mrgb;
    private static MySqliteModeHelper mySqliteModeHelper;
    private SQLiteDatabase db;

    private RGBDataBaseOne(Context context) {
    ...
    public static RGBDataBaseOne getInstance(Context context) {
        if (mrgb == null) {
            mrgb = new RGBDataBaseOne(context);
        }
        return mrgb;
    }
    ...
    public void update(String str, int i, int i2, int i3, int i4, int i5, String str2, String[] strArr) {
        ...
        if (str.equals(MySqliteModeHelper.RGBONE)) {
        ...
        this.db.update(MySqliteModeHelper.RGBONE, contentValues, str2, strArr);
    }
    ...
    public void insert(String str, int i, int i2, int i3, int i4, int i5) {
        ...
        this.db.insert(MySqliteModeHelper.RGBONE, null, contentValues);
    }
